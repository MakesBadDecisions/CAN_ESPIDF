/**
 * @file dis08070h.h
 * @brief CrowPanel ESP32 HMI 7.0-inch Display Configuration
 * 
 * Hardware-specific pin definitions and parameters for the DIS08070H display.
 * ESP32-S3-WROOM-1-N4R8 with 7" RGB LCD (800x480).
 */
...
#define DEVICE_NAME         "DIS08070H"
#define DEVICE_MODEL        "7inch_RGB_LCD"
...
// Blue pins (B0-B4)
#define PIN_B0  15  // GPIO_NUM_15
#define PIN_B1  7   // GPIO_NUM_7
#define PIN_B2  6   // GPIO_NUM_6
#define PIN_B3  5   // GPIO_NUM_5
#define PIN_B4  4   // GPIO_NUM_4

// Green pins (G0-G5)
#define PIN_G0  9   // GPIO_NUM_9
#define PIN_G1  46  // GPIO_NUM_46
#define PIN_G2  3   // GPIO_NUM_3
#define PIN_G3  8   // GPIO_NUM_8
#define PIN_G4  16  // GPIO_NUM_16
#define PIN_G5  1   // GPIO_NUM_1

// Red pins (R0-R4)
#define PIN_R0  14  // GPIO_NUM_14
#define PIN_R1  21  // GPIO_NUM_21
#define PIN_R2  47  // GPIO_NUM_47
#define PIN_R3  48  // GPIO_NUM_48
#define PIN_R4  45  // GPIO_NUM_45

// Control pins
#define PIN_HSYNC       39  // GPIO_NUM_39
#define PIN_VSYNC       40  // GPIO_NUM_40
#define PIN_DE          41  // GPIO_NUM_41 (HENABLE)
